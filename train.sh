...
CUDA_VISIBLE_DEVICES=0 python3 train.py --lr 0.01 --n_stgcnn 1 --n_txpcnn 5  --dataset trajectory_combined --tag social-stgcnn-trajectory_combined --use_lrschd --num_epochs 250 && echo "trajectory_combined Launched." &
P0=$!
